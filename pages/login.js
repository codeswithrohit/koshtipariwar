    ...
    <div class="container px-6 py-24 mx-auto lg:py-32">
            ...
            <form class="w-full lg:max-w-xl" onSubmit={handleFormSubmit}>
              ...
              />
                    ...
                    <div class="mt-8 md:flex md:items-center">
                        <button class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink-500 rounded-lg md:w-1/2 hover:bg-pink-400 focus:outline-none focus:ring focus:ring-pink-300 focus:ring-opacity-50">
                            Sign in
                        </button>

                        <a href="#" class="inline-block mt-4 text-center text-pink-500 md:mt-0 md:mx-6 hover:underline dark:text-pink-400">
        ...
        <div class="mt-8 md:mt-24 sm:flex sm:items-center">
            ...
            <div class="flex items-center mt-4 sm:mt-0 -mx-1.5 sm:w-1/2">
                <a class="mx-1.5 dark:hover:text-pink-400 text-gray-400 transition-colors duration-300 transform hover:text-pink-500" href="#">
