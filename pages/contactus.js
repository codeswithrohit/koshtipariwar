        ...
        <div class="lg:flex lg:items-center lg:-mx-10">
            <div class="lg:w-1/2 lg:mx-10">
                ...
                <form class="mt-12">
                    ...
                    <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink-900 rounded-md hover:bg-pink-900 focus:outline-none focus:ring focus:ring-pink-400 focus:ring-opacity-50">
                        get in touch
                    </button>
                </form>
            </div>
            ...
            <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-pink-600 dark:text-pink-900" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="mt-6 w-80 md:mt-8">
                    ...
                    <div class="flex mt-4 -mx-1.5 ">
                        <a class="mx-1.5 dark:hover:text-pink-900 text-gray-400 transition-colors duration-300 transform hover:text-pink-600" href="#">
