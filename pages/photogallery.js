    ...
    <div className='m-auto min-h-screen bg-white dark:bg-white'>
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-2xl font-semibold text-center text-red-300 capitalize lg:text-3xl dark:text-white">
            Program Photo
          </h1>
                ...
                <Link key={data.id} href={`/gallerydetails?id=${data.id}`}>
                  ...
                  >
                    <div className="w-full px-8 py-4 overflow-hidden rounded-b-lg backdrop-blur-sm bg-white/60 dark:bg-gray-800/60">
                      <h2 className="mt-4 text-2xl font-semibold text-red-300 capitalize dark:text-white">
                        {data.events}
                      </h2>
                    </div>
                  </div>
